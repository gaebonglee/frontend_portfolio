...
export const projects = [
  ...
  },
  {
    id: 2,
    title: "Twitter App",
    subTitle: "실시간 트위터 클론 프로젝트",
    description: [
      "Recoil을 이용한 전역 상태 관리와 React-router-dom을 활용한 라우팅 시스템을 구현했습니다.",
      "Firestore의 onSnapshot을 이용한 실시간 타임라인과 트윗 CRUD, 이미지 업로드, 해시태그 기능을 지원합니다.",
      "SNS 로그인(OAuth), 프로필 관리, 좋아요, 팔로우, 댓글 기능을 구현하여 사용자 경험을 향상시켰습니다. ",
      "SCSS를 활용한 반응형 웹을을 적용하고 Vercel을 통해 배포하였습니다. ",
    ],
    type: "PC 반응형",
    period: "2025.01.21 ~ 2025.01.24",
    skills: "React, Scss, Recoil, Firebase (Auth), Firestorage, Figma",
    image: "/images/project/twitter-app-thumnail.png",
    projectLink: "https://twitter-app-lake.vercel.app/",
    githubLink: "https://github.com/gaebonglee/twitter-app",
    contribution: "디자인 100%, 프론트100%, 백엔드 100%",
  },
  // {
  //   id: 2,
  //   title: "LUKS",
  ...
  // },
  {
    ...
    description: [
      ...
      "Vercel를 이용해 프로젝트를 배포했습니다.",
    ],
    type: "PC",
    period: "2025.01.13 ~ 2025.01.18",
    skills: "React, TypeScript, Scss, GSAP, Vercel",
    image: "/images/project/portfolio.png",
    projectLink: "https://frontend-portfolio-sepia.vercel.app/",
...

  {
    ...
    image: "/images/project/gblog.png",
  ...
  },
  {
    ...
    image: "/images/project/movie-app.png",
